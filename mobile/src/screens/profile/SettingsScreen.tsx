  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        {/* Admin Section - Only in Development */}
        {__DEV__ && (
          <View style={styles.section}>
            ...
            <TouchableOpacity 
              style={styles.settingItem}
              onPress={() => navigation.navigate('AdminCleanup')}
            >
              <View style={styles.settingInfo}>
                <Text style={[styles.settingTitle, { color: '#F44336' }]}>Admin Cleanup</Text>
                <Text style={styles.settingDescription}>Clean up Firebase data (DEV ONLY)</Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#CCCCCC" />
            </TouchableOpacity>
          </View>
